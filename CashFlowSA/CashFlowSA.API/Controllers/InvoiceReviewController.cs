...
{
    // Approving here is what actually triggers the Ollama risk scoring pipeline
    // (see ApproveInvoiceCommandHandler) -- this is the real invoice path AIController's
    // /test endpoint was built to rehearse before this controller existed.
    [ApiController]
